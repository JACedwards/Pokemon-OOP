...
class BuildTeam():
     ...
     # Think remove will be too hard because cannot search for name of a name of pokemon when it is nested in dictionary inside a list?
     ...
     # This one runs with no errors, but isn't removing pokemon dictionary
     def remove(self):
